...
const processPage = () => {
    ...
    const items = document.querySelector('.con1 .items');
    const indicator = document.querySelector('.con1 .indicator');
    const itemElements = document.querySelectorAll('.con1 .item');
    const previewImage = document.querySelector('.con1 .img-preview img');
    const itemImages = document.querySelectorAll('.con1 .item img');
