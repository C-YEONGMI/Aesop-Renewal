...
const introHeaders = [
    '<span>time to</span> ship brave ideas',
    '<span>time to</span> design, animate, iterate',
    '<span>time to</span> be brave with React & GSAP',
    '<span>time to</span> craft seamless UX',
    '<span>time to</span> chase bugs, embrace polish',
];
